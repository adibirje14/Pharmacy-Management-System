...
#------------------------------------------------------------------------------------------------------
    def additem(self):
        ...
        if self.entrymed.get()=="" and self.ref_var.get=='' and self.price.get()=='':
            ...
            if(oty>qua):   
                ...
                self.tax.set(str('%.2f'%((((sum(self.l))-(self.price.get()))*taxs)/100)))
                self.total.set(str('%.2f'%(((sum(self.l))+((((sum(self.l))-(self.price.get()))*taxs)/100)))))
            else :
    ...
    def genbill(self):
        if self.entrymed.get()=="" and self.ref_var.get=='' and self.price.get()=='':
            ...
            if(oty>m):  
                ...
                mycursor2.execute("insert into bill values (%s,%s,%s,%s,%s,%s)",(
                                                                                    self.date,
                                                                                    self.billno.get(),
                                                                                    m,
                                                                                    self.subtotal1.get(),
