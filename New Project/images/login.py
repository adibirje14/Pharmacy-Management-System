...
class Login_Window:
    def __init__(self,root):
        ...
        self.bg=ImageTk.PhotoImage(file=r"C:\Users\Ridham Jasani\Documents\ridmy\sunset.jpg")
        lbbg = Label(self.root,image=self.bg)
        lbbg.place(x=0,y=0,relwidth=1,relheight=1)
        frame=Frame(self.root,bg="black")
        frame.place(x=610,y=170,width=340,height=450)

        img1=Image.open(r"C:\Users\Ridham Jasani\Documents\ridmy\user.png")
        ...
        img2=Image.open(r"C:\Users\Ridham Jasani\Documents\ridmy\user.png")
        img2=img2.resize((25,25),Image.Resampling.LANCZOS)
        self.photoimage2=ImageTk.PhotoImage(img2)
        lbimg2 = Label(image=self.photoimage2,bg="black",borderwidth=0)
        lbimg2.place(x=650,y=323,width=25,height=25)

        img3=Image.open(r"C:\Users\Ridham Jasani\Documents\ridmy\lock.png")
